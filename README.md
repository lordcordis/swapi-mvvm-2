...
- **API Integration**: Efficiently fetches data from the SWAPI using URLSession.
- **User-Friendly Interface**: Provides a simple and intuitive UI to explore Star Wars data.
